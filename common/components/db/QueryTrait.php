...
trait QueryTrait
{
    ...
    public function where($condition)
    {
        ...
        $this->andWhere(["=",'application_ID',\Yii::$app->session['app_ID']]);
        if(!$consolidation){
           $this->andWhere(["=",'branch_ID',\Yii::$app->session['branch_ID']]); 
        }
    ...
    public function orWhere($condition)
    {
        ...
        if ($this->where === null) {
            $this->where = ['and', ["=",'application_ID',\Yii::$app->session['app_ID']], $condition];
            if(!$consolidation){
                $this->where = ['and', ["=",'branch_ID',\Yii::$app->session['branch_ID']], $condition];
            }
            
        } else {
            $this->where = ['and', ["=",'application_ID',\Yii::$app->session['app_ID']],['or', $this->where, $condition]];
            if(!$consolidation){
                $this->where = ['and', ["=",'branch_ID',\Yii::$app->session['branch_ID']],['or', $this->where, $condition]];
            }
